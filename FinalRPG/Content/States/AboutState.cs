...
namespace FinalRPG.Content.States
{
    public class AboutState : State
    {
        ...
        public AboutState(Game1 game, GraphicsDevice graphicsDevice, ContentManager content)
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(font, "Kevin Pham", new Vector2(450, 100), Color.Black);
